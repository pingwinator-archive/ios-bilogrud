...
#define isCamera [UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]
...
#define resultEditPhotoSizeiPad 527.0f

#define editPhotoPreViewSize 63.0f
#define editPhotoPreViewSizeiPad 114.0f
...
#define alertLabelFont [UIFont fontWithName:@"HomemadeApple" size:15]
#define alertTitleLabelFont [UIFont fontWithName:@"HomemadeApple" size:18]
...
#define buttonIndexDo 1
typedef enum{
    ManageActionType_Cansel,
    ManageActionType_Rotate,
    ManageActionType_Done
} ManageActionType;
...
#define imageName(name) [NSString stringWithFormat:@"%@%@", name, @".png"]

#define imagePNG(name) [UIImage imageNamed: imageName(name) ]
